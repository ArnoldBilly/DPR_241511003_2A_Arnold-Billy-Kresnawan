        ...
        <?php if(!empty($anggota)): ?>
            <?php foreach($anggota as $angg): ?>
                <tr>
                    ...
                    <td><a href="<?= site_url('admin/anggota/details/' .$angg['id_anggota'])?>">Detail</a> ||
                        <a href="<?= site_url('admin/anggota/edit/' .$angg['id_anggota']) ?>">Edit</a> || 
                        <a href="<?= site_url('admin/anggota/delete/' .$angg['id_anggota']); ?>" onclick="return confirm('Betul hapus anggota DPR atas nama <?= $angg['nama_depan']?> <?=  $angg['nama_belakang']?>?')">Delete</a>
                    </td>
                </tr>
            <?php endforeach; ?>
        <?php endif; ?>
